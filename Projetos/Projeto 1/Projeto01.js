...
if (contador == 0 ){
    console.clear()
    console.log(`   Infelimente você não consegue derrotar o mal sem o poder do artefato`)
    ...
    console.log("   Você falhou, mas ainda consegue fugir do reino antes que ele sucumba. ")
    console.log(`   Este é o fim de sua aventura ${nome} `)
} else if (contador == 3){
    console.clear()
    ...
    console.clear()
    console.log(`   Sem o artefato a batalha é dura mas você juntou algumas partes e junto com ${final} você vence`)
